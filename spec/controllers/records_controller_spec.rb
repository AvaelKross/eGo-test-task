...
RSpec.describe RecordsController, :type => :controller do
  ...
  let!(:owner) {User.create(login:'qwe',name:'qweqwe')}

  let(:valid_attributes) { {title: 'qewqwqwq', body: "qweqidsujfwyfdshijkn dshbfsjhk!", owner_id: owner.id} }

  let(:invalid_attributes) { {title: nil, body: nil, owner_id: nil} }
